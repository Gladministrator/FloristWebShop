...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <h3 style="margin: 5px 0 0 0; text-align: center; color: darkblue">Order Flowers</h3>
  <div class="divOrderHeading">
    <div class="divRow">
      ...
      <div class="divCol2">
        ...
        <asp:RequiredFieldValidator
          ID="rvOccasion"
          runat="server"
          ErrorMessage="Select Occasion"
          ControlToValidate="dlOccasion"
          ForeColor="Red"
          Font-Size="Large"
          Text="*"
          ToolTip="Select Occasion"
      ...
      <div class="divCol2">
        ...
        <asp:RequiredFieldValidator
          ID="rfFlower"
          runat="server"
          ErrorMessage="Select Flower"
          ControlToValidate="dlFlower"
          ForeColor="Red"
          Font-Size="Large"
          Text="*"
          ToolTip="Select Flower"
          ValidationGroup="Order"
          InitialValue="-1"></asp:RequiredFieldValidator>
      </div>
    </div>
      ...
      <div class="divRow">
        ...
        <div class="divCol2">
          ...
          <asp:RequiredFieldValidator
            ...
            Text="*"
            ForeColor="Red"
            ToolTip="Street Address Required"
            Font-Size="Large"
            ValidationGroup="Order"></asp:RequiredFieldValidator>
        </div>
        <div class="divCol1">
      ...
      <div class="divRow">
        ...
        <div class="divCol2">
          ...
          <asp:RequiredFieldValidator
            ...
            ControlToValidate="dlRegion"
            Text="*"
            ForeColor="Red"
            ToolTip="Region Required"
            Font-Size="Large"
            ValidationGroup="Order"
            InitialValue="-1"></asp:RequiredFieldValidator>
        </div>
    ...
    <asp:Label
      ...
      runat="server"
      Visible="false"
      CssClass="lbl-error-msg centered-field"></asp:Label>
    <div>
