...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="flex-container">
    ...
    <div class="flex-item">
      ...
      <div>
        <asp:RequiredFieldValidator
          ID="rvSecretQuestion1"
          runat="server"
          ErrorMessage="Secret Question 1 is Required"
          Text="*"
          ControlToValidate="txtSecretQuestion1"
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="Secret Question 1 is Required"
          ValidationGroup="Profile"></asp:RequiredFieldValidator>
      </div>
    </div>
    <div class="flex-item">
      ...
      <div>
        <asp:RequiredFieldValidator
          ID="rvSecretAnswer1"
          runat="server"
          ErrorMessage="Secret Answer 1 is Required"
          Text="*"
          ControlToValidate="txtSecretAnswer1"
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="Secret Answer 1 is Required"
          ValidationGroup="Profile"></asp:RequiredFieldValidator>
      </div>
    </div>
    <div class="flex-item">
      ...
      <div>
        <asp:RequiredFieldValidator
          ID="rvSecretQuestion2"
          runat="server"
          ErrorMessage="Secret Question 2 is Required"
          Text="*"
          ControlToValidate="txtSecretQuestion2"
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="Secret Question 2 is Required"
          ValidationGroup="Profile"></asp:RequiredFieldValidator>
      </div>
    </div>
    <div class="flex-item">
      ...
      <div>
        <asp:RequiredFieldValidator
          ID="rvSecretAnswer2"
          runat="server"
          ErrorMessage="Secret Answer 2 is Required"
          Text="*"
          ControlToValidate="txtSecretAnswer2"
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="Secret Answer 2 is Required"
          ValidationGroup="Profile"></asp:RequiredFieldValidator>
      </div>
    </div>
  </div>
  ...
  <div style="margin-top: 15px">
    <asp:Label
      ...
      runat="server"
      Visible="false"
      CssClass="centered-field"
      Font-Bold="True"
      Font-Size="Medium"
      ForeColor="Red"
      Text="Error Msg"></asp:Label>
