...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <h3 style="text-align: center; color: #b36200; margin: 0 0; font-size: 22px">
    Please fill the below information to reset your password
  </h3>
  <div class="main-recovery-content">
    <div class="recovery-content">
      ...
      <div>
        ...
        <asp:RequiredFieldValidator
          ...
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="User Name Required"
          ValidationGroup="username"></asp:RequiredFieldValidator>
      </div>
      <asp:Label
        ID="lblErrorUserName"
        runat="server"
        Visible="false"
        Text="Invalid User Name"></asp:Label>
      <asp:Button
        ID="btnSubmitUserName"
        runat="server"
        CssClass="styled-btn"
    ...
    <asp:Panel CssClass="recovery-content" ID="pnlRecoveryQuestions" runat="server" Visible="false">
      <asp:Label runat="server" Font-Bold="True" CssClass="label-recovery"
        >Please answer your security questions</asp:Label
      >
      ...
      <div>
        ...
        <asp:RequiredFieldValidator
          ...
          ErrorMessage="Security Answer is Required"
          Text="*"
          ControlToValidate="txtAnswer2"
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="Security Answer is Required"
          ValidationGroup="Questions"></asp:RequiredFieldValidator>
      </div>
      <asp:Label
        ID="lblAnswersWrong"
        runat="server"
        Text="Incorrect Answer(s)"
      ...
      <asp:Button
        ...
        Text="Submit Answers"
        ValidationGroup="Questions"
        OnClick="btnSubmitAnswers_Click" />
    </asp:Panel>
    <asp:Panel CssClass="recovery-content" ID="pnlResetPassword" runat="server" Visible="false">
      ...
      <div>
        ...
        <asp:RequiredFieldValidator
          ...
          Text="*"
          ControlToValidate="txtResetPassword"
          Font-Size="Large"
          ForeColor="Red"
          ToolTip="A New Password is Required"
      ...
      <asp:Button
        ...
        Text="Reset Password"
        ValidationGroup="Password"
        OnClick="btnSubmitPassword_Click" />
    </asp:Panel>
    ...
    <asp:LinkButton
      CssClass="centered-field link-button"
      ID="lnkReturnLogin"
      runat="server"
      Font-Bold="True"
      ForeColor="#000066"
      OnClick="lnkReturnLogin_Click"
      >Return to Login Page</asp:LinkButton
    >
  </div>
  <br />
</asp:Content>
