...
CodeBehind="Login.aspx.cs" Inherits="Florist.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="divLoginLeft">
    ...
    <div class="password-box">
      <asp:Label
        ...
        runat="server"
        Text="Password"
        CssClass="labelSpacingPassword"></asp:Label>
    ...
    <div>
      <div class="divHeading">
        <asp:LinkButton
          ...
          OnClick="lnkCreateProfile_Click"
          >Create Profile</asp:LinkButton
        >
      </div>
      <div class="divHeading">
        <asp:LinkButton
  ...
  <div class="divLoginRight">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/LoginImage.png" Width="305px" />
  </div>
</asp:Content>
